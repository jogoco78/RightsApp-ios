...
class ParticlesTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        if DBManager.shared.openDatabase(){
            subjects = DBManager.shared.getSubjectsByTag(idTags: tagsInt, language: language)
        }
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "ParticleSubjectItem", for: indexPath)
